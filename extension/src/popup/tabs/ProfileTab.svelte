...
<div class="section-title" style="margin-top:0; padding-top:0; border-top:none;">About You</div>
...
<CollapsibleSection title="Document Profile (Selbstauskunft)">
  <div class="grid-2">
    <div class="field">
...
<CollapsibleSection title="Form Auto-Fill">
  <div class="grid-2">
    <div class="field">
